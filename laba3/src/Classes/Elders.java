...
public class Elders implements EldersList {
    ...
    public void checkReasonsForSetPlace(NewContinents newContinents, Shoggots shoggots) {
        if (newContinents.getCount() > 0 && shoggots.getBrawl()) {
            reasonsForSetPlace = 2;
        } else if ((newContinents.getCount() == 0 && !shoggots.getBrawl())) {
